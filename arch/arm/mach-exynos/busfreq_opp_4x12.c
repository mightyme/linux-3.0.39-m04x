...
static unsigned int exynos4_qos_value[BUS_QOS_MAX][LV_END][4] = {
	/* Normal Status */
	{
		...
		{0x00, 0x00, 0x00, 0x00},	/* MIF : 267MHz INT : 200MHz */
		{0x00, 0x00, 0x00, 0x00},	/* MIF : 267MHz INT : 160MHz */
		{0x06, 0x03, 0x06, 0x0a},	/* MIF : 160MHz INT : 160MHz */
		{0x04, 0x03, 0x04, 0x0a},	/* MIF : 133MHz INT : 133MHz */
		{0x03, 0x07, 0x06, 0x02},	/* MIF : 100MHz INT : 100MHz */
	},
	/* Fimc capture, MFC */
	{
		...
		{0x03, 0x05, 0x06, 0x02},	/* MIF : 100MHz INT : 100MHz */
	},
};
...
static unsigned int exynos4x12_get_int_volt(unsigned long index)
{
