...
bool trustzone_flag __read_mostly = false;
...
void __init exynos4_map_io(void)
{
	...
	if (soc_is_exynos4210()) {
		...
		s5p_jpeg_setname("jpeg_v1");
	} else {
		s3c_adc_setname("samsung-adc-v4");
		exynos4x12_adc_setup_resource();
		s5p_jpeg_setname("jpeg_v2");
	}
...
{
	pr_debug("%s: initializing clocks\n", __func__);
...
static int __init exynos4_l2x0_cache_init(void)
{
	...
	/* L2C-310 version: 4412:r3p2; 4212:r3p1; 4210:r3p0
	  * So we enable 4212 double linefill in PL310 Prefetch Control Register in bit30 
	  * to improve performance.
	  */
	u32 prefetch = (soc_is_exynos4412() || soc_is_exynos4212()) ?
...
int __init exynos4_init(void)
{
	...
	pr_debug("EXYNOS4: Initializing architecture\n");
