...
void exynos4_sys_powerdown_conf(enum sys_powerdown mode)
{
	...
	if (machine_is_m031() || machine_is_m032() || machine_is_m040()) {
		if(wm8994_isalwayson(NULL))
			...
			exynos4_pmu_config[entry_cnt-1].val[SYS_SLEEP] = 0;			
	}	
#endif
