...
static const struct modem_gpio_info_table m041_modem_gpio_table[] = {
	...
	{"MDM_RESEND", 	1, M041_GPIO_MODEM_RESEND, 		S3C_GPIO_INPUT, 		GPIO_SETPIN_NONE, 	GPIO_PULL_UP, 		GPIO_DRVSTR_LV1},/*M041 Modem RESEND*/
	...
	{"MDM_ALIVE", 	1, M041_GPIO_MODEM_ALIVE, 		S3C_GPIO_INPUT, 		GPIO_SETPIN_NONE, 	GPIO_PULL_UP, 		GPIO_DRVSTR_LV1},/*M041 Modem Alive*/

#ifndef CONFIG_MX2_SC8803G_TEST
	{"AP_TO_MDM2",	1, M041_GPIO_AP_TO_MODEM2, 		S3C_GPIO_OUTPUT, 	GPIO_SETPIN_LOW, 	GPIO_PULL_NONE, 		GPIO_DRVSTR_LV1},/*M041 AP TO MDM2*/
	{"AP_TO_MDM1", 	1, M041_GPIO_AP_TO_MODEM1, 		S3C_GPIO_OUTPUT, 	GPIO_SETPIN_LOW, 	GPIO_PULL_NONE, 		GPIO_DRVSTR_LV1},/*M041 AP TO MDM1*/
	{"MDM_TO_AP1", 	1, M041_GPIO_MODEM_TO_AP1, 		S3C_GPIO_INPUT, 		GPIO_SETPIN_NONE, 	GPIO_PULL_UP, 		GPIO_DRVSTR_LV1},/*M041 MDM TO AP1*/
	{"MDM_TO_AP2", 	1, M041_GPIO_MODEM_TO_AP2, 		S3C_GPIO_INPUT, 		GPIO_SETPIN_NONE, 	GPIO_PULL_UP,		GPIO_DRVSTR_LV1},/*M041 MDM TO AP2*/
#endif	
