...
struct wm8958_mbc_cfg m040_mbc_cfgs[] = {
	{
		...
		.coeff_regs[12] = 0x0043,
		.coeff_regs[13] = 0x3525,
		.coeff_regs[14] = 0x0006,
		.coeff_regs[15] = 0x6A4A,
		.coeff_regs[16] = 0x0043,
		.coeff_regs[17] = 0x6079,
		...
		.cutoff_regs[6] = 0x002B,
		.cutoff_regs[7] = 0x3769,
		.cutoff_regs[8] = 0x0017,
		.cutoff_regs[9] = 0xB53B,
		.cutoff_regs[10] = 0x0008,
		.cutoff_regs[11] = 0xE7A2,
		.cutoff_regs[12] = 0x00A7,
		.cutoff_regs[13] = 0x0D1C,
		.cutoff_regs[14] = 0x0059,
		.cutoff_regs[15] = 0xFE0F,
		.cutoff_regs[16] = 0x0099,
		.cutoff_regs[17] = 0xD861,
...
static struct max77665_platform_data __initdata m040_max77665_info = {
	...
	.chgin_ilim_usb = 400,			/* 60mA ~ 2580mA */
	.chgin_ilim_ac = 900,
#ifdef CONFIG_USB_GADGET
