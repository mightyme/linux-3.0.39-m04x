...
static void process_int(int intr_type,struct fsa8108_info* info)
{
	...
	{
	    pr_err("%s : interrupt trigger is wrong.\n", __func__);
	}
...
/*** Set Control bits: All key/Double/Long/3-4 pole/LDO ***/
    ...
    pr_err("%s: FSADEVICE_ID =%d \n",__func__,fsa8108_GetValue(FSA8108_REG_DEVICE_ID,0xFF,0));
...
//	#define KEY_FN_F6		0x1d7
	...
	printk("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$earphone detection fsa8108_probe begin");
...
MODULE_AUTHOR("Chris Jeong <chris.jeong@fairchildsemi.com");
MODULE_DESCRIPTION("I2C bus driver for FSA8108 Jack detection IC");
