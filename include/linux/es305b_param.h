...
// !Preset id: 0 ; Handson_NB (CT)
	...
	0x80, 0x0C, 0x0A, 0x04, 0x80, 0x0D, 0x00, 0x02, // ; 0x800C: SetDeviceParmID, 0x0A: PCM0, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0002:TxRising / RxFalling
	...
	0x80, 0x0C, 0x0C, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0001:TxRising/RxFalling
...
// ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
// ; Meizu M040
// ; !Preset id: 1 ; Wired Headset_NB (1MD)
// ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	0x80, 0x52, 0x00, 0x00, // ; 0x8052:Disable digital pass through
	0x80, 0x26, 0x00, 0x01, // ; 0x8026:SelectRouting, 0x0001:
	0x80, 0x0C, 0x0A, 0x04, 0x80, 0x0D, 0x00, 0x02, // ; 0x800C: SetDeviceParmID, 0x0A: PCM0, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0002:TxRising / RxFalling
	...
	0x80, 0x0C, 0x0C, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0001:TxRising/RxFalling
	0x80, 0x1B, 0x04, 0x00, // ; 0x801B:SetDigitalInputGain, 0x04:PCM-C left, 0x00:(0 dB)
	0x80, 0x15, 0x00, 0xF6, // ; 0x8015:SetDigitalOutputGain, 0x00:PCM-A left, 0xF6:(-10 dB)
	...
	0x80, 0x17, 0x00, 0x63, 0x80, 0x18, 0xFF, 0xA0, // ; SetAlgorithmParmID, 0x0063:    AEC Rx Energy Threshold (dB) -- SetAlgorithmParm, 0xFFA0: (-96 dB)
	0x80, 0x17, 0x00, 0x64, 0x80, 0x18, 0x00, 0xC8, // ; SetAlgorithmParmID, 0x0064:    AEC Rx Energy Threshold Time (ms) -- SetAlgorithmParm, 0x0064: (? ms)
};
...
static const u8 incall_bt_buf[] =
{
	...
	0x80, 0x0C, 0x0D, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0001:TxRising / RxFalling
	...
	0x80, 0x0C, 0x0C, 0x02, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x02: PCM DelFromFsTx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0C, 0x03, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x03: PCM DelFromFsRx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0C, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0003:TxRising/RxFalling
...
static const u8 incall_bt_vpoff_buf[] =
{
	...
	0x80, 0x0C, 0x0D, 0x02, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x02: PCM DelFromFsTx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0D, 0x03, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x03: PCM DelFromFsRx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0D, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0001:TxRising / RxRising
	0x80, 0x0C, 0x0D, 0x05, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x05: PCM Endianness0x800D: SetDeviceParm, 0x0001:Big Endian
	0x80, 0x0C, 0x0D, 0x06, 0x80, 0x0D, 0x00, 0x00, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x06: PCM Tristate Enable0x800D: SetDeviceParm, 0x0000: Disable
	0x80, 0x0C, 0x0D, 0x07, 0x80, 0x0D, 0x00, 0x00, // ; 0x800C: SetDeviceParmID, 0x0B: PCM1, 0x07: PCM Audio Port Mode0x800D: SetDeviceParm, 0x0000: PCM
	0x80, 0x0C, 0x0C, 0x00, 0x80, 0x0D, 0x00, 0x0F, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x00: PCM WordLength0x800D: SetDeviceParm, 0x000F: 16 Bits
	0x80, 0x0C, 0x0C, 0x02, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x02: PCM DelFromFsTx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0C, 0x03, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x03: PCM DelFromFsRx0x800D: SetDeviceParm, 0x0001: (1 clocks)
	0x80, 0x0C, 0x0C, 0x04, 0x80, 0x0D, 0x00, 0x03, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x04: PCM Latch Edge0x800D: SetDeviceParm, 0x0002:TxRising/RxFalling
	0x80, 0x0C, 0x0C, 0x05, 0x80, 0x0D, 0x00, 0x01, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x05: PCM Endianness0x800D: SetDeviceParm, 0x0001:Big Endian
	0x80, 0x0C, 0x0C, 0x06, 0x80, 0x0D, 0x00, 0x00, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x06: PCM Tristate Enable0x800D: SetDeviceParm, 0x0000: Disable
	0x80, 0x0C, 0x0C, 0x07, 0x80, 0x0D, 0x00, 0x00, // ; 0x800C: SetDeviceParmID, 0x0C: PCM2, 0x07: PCM Audio Port Mode0x800D: SetDeviceParm, 0x0000: PCM
	0x80, 0x51, 0x00, 0x08, // ; 0x8051:SetMasterPortSampleRate, 0x0008:8kHz
